...
여기서는 Arm을 사용하는 SBC[^2] 컴퓨터에 mongodb 3.4 버전을 설치하는 과정이다.
 - Odroid C2 for 64bit
 - Armbian Ubuntu Xeniel

이 문서는 [Install-mongodb-on-ubuntu](https://docs.mongodb.com/v3.4/tutorial/install-mongodb-on-ubuntu/)를 바탕으로 OdroidC2에 설치를 진행한다.
